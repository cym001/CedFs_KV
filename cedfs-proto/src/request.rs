...
pub struct ReceiveRequest {
    ...
    pub max_tokens: i32,
    #[prost(string, tag = "4")]
    pub pre_request_id: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/request.RequestServer/Receive",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("request.RequestServer", "Receive"));
...
pub mod request_server_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/request.RequestServer/Receive" => {
                    ...
                    struct ReceiveSvc<T: RequestServer>(pub Arc<T>);
                    impl<
                        T: RequestServer,
                    ...
                    for ReceiveSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RequestServer>::receive(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "request.RequestServer";
